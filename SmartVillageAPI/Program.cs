...
using System.Text;
using Microsoft.Extensions.FileProviders; // للتعامل مع ملفات الفيديو
...
builder.Services.AddHostedService<CameraSyncService>(); // خدمة مزامنة الكاميرات
...
// السماح بالوصول لفيديوهات الكاميرا المسجلة
// تأكدي أن المسار "C:\\MediaRecords" يطابق ما وضعتيه في mediamtx.yml
if (Directory.Exists("C:\\MediaRecords"))
{
    app.UseStaticFiles(new StaticFileOptions
    {
        FileProvider = new PhysicalFileProvider("C:\\MediaRecords"),
